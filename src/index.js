    ...
    function setupComplete(shipsPlacement,playerName){
        if(playerName==player1_Name){
            ...
            if(mode=='pvp'){
                ...
                mainDiv.removeChild(currentMainDiv);
                currentMainDiv=startGame(mode,player1_Name,player1_ships,null,null,gameOver)  
            }
        } 
        else{
            player2_ships=shipsPlacement;
            mainDiv.removeChild(currentMainDiv);
            currentMainDiv=startGame(mode,player1_Name,player1_ships,player2_Name,player2_ships,gameOver)
        }
    }
